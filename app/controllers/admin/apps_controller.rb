class Admin::AppsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @app.save
        format.html { redirect_to admin_app_url(@app), notice: 'App was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @app.update(app_params)
        format.html { redirect_to admin_app_url(@app), notice: 'App was successfully updated.' }
